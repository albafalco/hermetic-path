    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--bg-primary)' }}>
      <div className="w-full max-w-md">
        ...
        <div className="card-glass p-8">
          <h2 className="text-xl font-cinzel mb-6 text-center" style={{ color: 'var(--text-primary)' }}>{t('auth.login')}</h2>
          ...
          <p className="mt-4 text-center text-sm font-crimson" style={{ color: 'var(--text-secondary)' }}>
            {t('auth.noAccount')}{' '}
            <Link href={`/${locale}/auth/register`} style={{ color: 'var(--gold-primary)' }}>
              {t('auth.register')}
            </Link>
          </p>
        </div>
